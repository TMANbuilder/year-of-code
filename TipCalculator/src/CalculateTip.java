...
public class CalculateTip {
	...
	public static void main(String args[]) {
		...
		gathering.setBillTotal(getValidFloat(scanner,"What was the bill total?\n$"));
		gathering.setTipPercentage(getValidFloat(scanner, "How much would you like to tip (%)?\n"));
		gathering.setNumGuests(getValidInt(scanner, "How many people will be splitting the bill?\n"));
